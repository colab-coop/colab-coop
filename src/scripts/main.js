...
$(document).ready(function() {
  ...
  if (!(window.localStorage.getItem('colab-coop-notrack-notified') === 'true')) {
    ...
    text.innerHTML = 'To gain useful information about how visitors use our site, we use Simple Analytics. This analytics software gives us insight about our visitors in general, but not about individuals, as it does not track individual visitors and does not store any personal identifiable information.';
