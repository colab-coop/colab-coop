...
Mikael Cho is the founder of [Crew](http://wwww.crew.com/), an online marketplace that connects projects with designers and developers. We talk to Mikael about .
...
<p>Crew is a community of independent designers and developers. We connect them with short-term, vetted, paid projects. We actually have vetting on both sides. I used to be an independent designer and I also used to work at an agency. A lot of what we've built into Crew is to solve the issues and problems that I've seen in this creative process. When you're working with someone who might be independent or located in a different country or city.</p>

<p>I'm the founder of Crew. We have a network of 400 pre-vetted designers and developers, all inside of Crew. We connect them with projects and that's all done through Crew. The project management, the payment, everything else is also done through our site.</p>
